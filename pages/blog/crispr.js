...
function Blog3({id}) {
    ...
    const fetchVoteStatus = async (id) => {
        const { data, error } = await supabase
          .from('votes')
          .select('vote_type')
          .eq('post_id', id)
        ...
        <div className={styles.blogPage}>
            <div className={styles.blogContent}>
              ...
              <div className={styles.blogCard}>
                                <p>
                                "Imagine having the power to edit the DNA of living organisms—welcome to the world of 
                                CRISPR, where science fiction is becoming science fact!"  
              </p>
             </div>
              </div>
...
produce.               
              ...
              <div className={styles.blogCard}>
                                <p>
                What's more astounding is the way it was discovered! The discovery of such clustered 
DNA occured independently  in three different parts of the world. The first discovery was in 
1987 by Yoshizumi who was a researcher in Osaka University. It was serendipity. They 
accidentally cloned part of a CRISPR sequence together with the "iap" gene of Escherichia coli (a 
bacteria). The second discovery occured in 1993. Two researchers of mycobacterium 
tuberculosis in Netherlands discovered the diversity of sequences in the bacteria. The third 
discovery was by Francisco Mojica at the University of Alicante in Spain. He studied the function 
of repeats in the archaeal species Haloferax and Haloarcula.Transcription of the interrupted 
repeats was the first full characterization of CRISPR.  
              </p>
             </div>
              </div>
              <div className='content-section'>
...
and early 1990s. 
                        ...
                        <div className={styles.imageGallery}>
                            ...
                            <Image src="/crispr-img.png" alt="crispr" width={500} height={300} className={styles.blogImage} />
