...
function Blog() {
  const blogPosts = [
    ...
    },
    {
      ...
      author: <a href="https://in.linkedin.com/in/aakanksha-pansare-43744a350" target="_blank" rel="noopener noreferrer" className={styles.authorLink}>Aakanksha Pansare</a>,
        ...
        <div style={{ justifyContent: 'center' }} className="row py-5">
          {blogPosts.map((post) => (
            <div key={post.id} className="col-md-4">
              ...
              >
<Link href={`/blog/${post.id === 1 ? "tarzan" 
    : post.id === 2 ? "data-loss" 
    : post.id === 3 ? "nanotech-application" 
    : post.id === 4 ? "traditional-algo" 
    : post.id === 5 ? "crispr" 
    : "default-blog"}`} legacyBehavior>
